...
Java, Kotlin, Ruby, Swift, and PHP. Import resolution follows relative
...
modules aren't file-scoped and PHP's PSR-4 autoloading is
configuration-dependent, so imports for those two are left unresolved.
